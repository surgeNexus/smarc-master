...
router.get("/minutescollection", middleware.isLoggedIn, function(req, res){
    Minutes.find({}, function(err, foundMinutes){
        if(err || !foundMinutes){
            req.flash("error", "Something went wrong");
            res.redirect("back")
        } else {
            res.render("minutes/collection", {foundMinutes: foundMinutes});
        };
    });
});

router.get("/minutescollection/new", middleware.isLoggedIn, function(req, res){
...
router.post("/", middleware.isLoggedIn, function(req, res){
    ...
    Minutes.create(newMinutes, function(err){
        if(err || !newMinutes){
            ...
            res.redirect("/info/minutes/minutescollection");
        };
    });
});

router.get("/minutescollection/:id", middleware.isLoggedIn, function(req, res){
...
router.put("/minutescollection/:id", middleware.isLoggedIn, function(req, res){
...
router.delete("/minutescollection/:id", middleware.isLoggedIn, function(req, res){
