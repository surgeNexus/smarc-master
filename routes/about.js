...
router.get('/aboutcollection/new', middleware.isAdmin, function (req, res) {
...
router.get('/aboutcollection/:id', middleware.isAdmin, function (req, res) {
...
router.put('/aboutcollection/:id', middleware.isAdmin, function (req, res) {
...
router.delete('/aboutcollection/:id', middleware.isAdmin, function (req, res) {
